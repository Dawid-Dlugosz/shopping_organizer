...
abstract class _Initial extends ShoppingListState {
...
abstract class _Loading extends ShoppingListState {
...
class __$$AddedImplCopyWithImpl<$Res>
    extends _$ShoppingListStateCopyWithImpl<$Res, _$AddedImpl>
...
class _$AddedImpl extends _Added {
  const _$AddedImpl(this.id) : super._();
  ...
  @override
  String toString() {
    return 'ShoppingListState.added(id: $id)';
  }
...
abstract class _Added extends ShoppingListState {
  const factory _Added(final String id) = _$AddedImpl;
...
class _$LoadedImpl extends _Loaded {
  const _$LoadedImpl({required this.shoppingListContainer, this.error})
      : super._();
  ...
  @override
  String toString() {
    return 'ShoppingListState.loaded(shoppingListContainer: $shoppingListContainer, error: $error)';
  }
  ...
  TResult when<TResult extends Object?>({
    ...
    return loaded(shoppingListContainer, error);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    return loaded?.call(shoppingListContainer, error);
  }
...
abstract class _Loaded extends ShoppingListState {
  const factory _Loaded(
      {required final ShoppingListContainer shoppingListContainer,
      final bool? error}) = _$LoadedImpl;
