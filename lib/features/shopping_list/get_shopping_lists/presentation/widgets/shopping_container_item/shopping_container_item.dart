...
import 'package:shopping_organizer/core/widgets/banner_widget.dart';
...
class ShoppingContainerItem extends StatelessWidget {
  const ShoppingContainerItem({
    required this.shoppingListContainer,
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      children: [
        if (showBanner) const BannerWidget(),
        Card(
          child: InkWell(
